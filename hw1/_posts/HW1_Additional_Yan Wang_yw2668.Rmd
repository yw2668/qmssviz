...
####As a R beginner, I was not able to draw many graphics in Homework 1. Therefore here I'd like to add an additional homework creating an interaction chart based on the real-world data of the company I work for.
